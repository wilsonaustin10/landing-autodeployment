    ...
    <footer className="bg-footer-bg text-footer-text">
      <div className="max-w-6xl mx-auto px-4 py-12">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center">
              <Image
                src="/https:&#x2F;&#x2F;firebasestorage.googleapis.com&#x2F;v0&#x2F;b&#x2F;allied-advantage-automation.firebasestorage.app&#x2F;o&#x2F;logos%2F1752548794725-0m6s74%2FOTW%20Homebuyers.png?alt&#x3D;media&amp;token&#x3D;85bd1328-2b74-47df-8faa-139f2caa656e"
                alt="AutoDeployment"
                width={120}
                height={120}
                className="mr-2"
            ...
            <div className="space-y-2">
              ...
              <a 
                href="mailto:test@autodeploy.com"
                className="flex items-center space-x-2 text-footer-text/80 hover:text-footer-hover transition-colors"
              >
                <Mail className="h-4 w-4" />
                <span>test@autodeploy.com</span>
              </a>
            </div>
          </div>
        ...
        <div className="mt-12 pt-8 border-t border-footer-text/20 text-center text-footer-text/80">
          <p>© {new Date().getFullYear()} AutoDeployment. All rights reserved.</p>
